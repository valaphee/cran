...
@Node("Logic/And")
class And(
    @get:In ("A"    , Bin, "") @get:JsonProperty("in_a") val inA: DataPath,
    @get:In ("B"    , Bin, "") @get:JsonProperty("in_b") val inB: DataPath,
    @get:Out("A ∧ B", Bin    ) @get:JsonProperty("out" ) val out: DataPath
) : StatelessNode() {
