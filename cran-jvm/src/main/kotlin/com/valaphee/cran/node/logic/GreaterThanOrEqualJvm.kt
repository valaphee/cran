 ...
 * @author Kevin Ludwig
 */
@NodeDef("jvm", GreaterThanOrEqual::class)
object GreaterThanOrEqualJvm : NodeJvm<GreaterThanOrEqual> {
    override fun initialize(node: GreaterThanOrEqual, scope: Scope) {
